import{Errors}from"./_Types.js";import{injectInGlobalObject,functionRegistrations as registrations}from"../System/RegistrationHelpers.js";import{EventProvider}from"./EventProvider.js";let Data;
/**
 ...
 * @param name Name of the function
 * @preserve (Part of the public API)
 */export function getFunctionVersion(name){let module=Data?.Modules.functions.map.get(name);return module&&module.error===Errors.NONE&&module.description&&"object"==typeof module.description.version?module.description.version:null}TcHmi.Functions={registerFunction,registerFunctionEx,getFunction,getFunctionVersion,registerFrameworkFunction};