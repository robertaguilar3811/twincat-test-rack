import type { BindingMode, DestroyFunction, IResultObject, SymbolTag } from './_Types.js';
...
export declare class SymbolExpression {
     ...
     * @preserve (Part of the public API)
     */
    resolve(callback: (data: Symbol.IReadResultObject<SymbolExpression>) => void): DestroyFunction;
     ...
     * @preserve (Part of the public API)
     */
    watch(callback: (data: Symbol.IReadResultObject<SymbolExpression>) => void): DestroyFunction;
}
export declare namespace SymbolExpression {
    ...
    interface IParseResultObject extends IResultObject {
        data?: IParseData;
    }
}
