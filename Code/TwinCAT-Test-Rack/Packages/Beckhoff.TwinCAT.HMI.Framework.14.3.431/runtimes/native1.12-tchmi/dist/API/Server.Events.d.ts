...
type tListResult<TPayload = any, TParams extends Dictionary<any> = Dictionary<any>> = ListResult<TPayload, TParams>;
type tSubscriptionResult<TPayload = any, TParams extends Dictionary<any> = Dictionary<any>> = SubscriptionResult<TPayload, TParams>;
...
type tMessageOrAlarm<T extends Dictionary<any> = Dictionary<any>> = MessageOrAlarm<T>;
type tMessage<T extends Dictionary<any> = Dictionary<any>> = Message<T>;
type tAlarm<T extends Dictionary<any> = Dictionary<any>> = Alarm<T>;
...
type tEvent<TPayload = any, TParams extends Dictionary<any> = Dictionary<any>> = Event<TPayload, TParams>;
...
declare global {
    namespace TcHmi.Server {
        ...
        namespace Events {
            ...
            type ListResult<TPayload = any, TParams extends Dictionary<any> = Dictionary<any>> = tListResult<TPayload, TParams>;
            type SubscriptionResult<TPayload = any, TParams extends Dictionary<any> = Dictionary<any>> = tSubscriptionResult<TPayload, TParams>;
            ...
            type MessageOrAlarm<T extends Dictionary<any> = Dictionary<any>> = tMessageOrAlarm<T>;
            type Message<T extends Dictionary<any> = Dictionary<any>> = tMessage<T>;
            type Alarm<T extends Dictionary<any> = Dictionary<any>> = tAlarm<T>;
            type PayloadEvent<T = any> = tPayloadEvent<T>;
            let ChangeType: typeof _ChangeType;
            type ChangeType = tChangeType;
            type Event<TPayload = any, TParams extends Dictionary<any> = Dictionary<any>> = tEvent<TPayload, TParams>;
