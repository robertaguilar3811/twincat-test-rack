...
declare const _getDateTimeFormatter: typeof Localization.getDateTimeFormatter;
declare const _formatDate: typeof Localization.formatDate;
declare const _parseDate: typeof Localization.parseDate;
declare const _parseInt: typeof Localization.parseInt;
type tDateParts = Localization.DateParts;
type tParseOptions = Localization.ParseOptions;
type tFormatOptions = Localization.FormatOptions;
type tFormatType = Localization.FormatType;
declare global {
    namespace TcHmi {
        /**
         * Allows handling date and time formatting.
