 ...
 */
declare function register<C extends baseTcHmiControl>(controlTypeName: string, constructor: baseTcHmiControlConstructor<C>, directory: string, template?: string | null): void;
/**
 * Register a control.
 * The Framework will fetch and interprete the Description.json in the Control Directory and optionally load a HTML Template file
 * @param controlTypeName Name of the Control type.
...
type tControlAttributeList = ControlAttributeList;
type tControlAccessDescription = ControlAccessDescription;
type tBaseTcHmiControlConstructor<C extends baseTcHmiControl> = baseTcHmiControlConstructor<C>;
declare global {
    namespace TcHmi {
        /**
        ...
        namespace Controls {
            ...
            type ControlAttributeList = tControlAttributeList;
            type ControlAccessDescription = tControlAccessDescription;
            type baseTcHmiControlConstructor<C extends baseTcHmiControl> = tBaseTcHmiControlConstructor<C>;
        }
    }
}
