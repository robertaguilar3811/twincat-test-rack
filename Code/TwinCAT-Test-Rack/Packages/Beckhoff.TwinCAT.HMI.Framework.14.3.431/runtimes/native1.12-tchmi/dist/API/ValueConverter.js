 ...
 * @template T Type of the resulting object.
 * @preserve (Part of the public API)
 */export function toObjectEx(value,options){const defaultValue=options?.defaultValue??null;let res={error:Errors.NONE,value:defaultValue};if(null==value)return res.error=Errors.E_VALUE_INVALID,res.details={code:Errors.E_VALUE_INVALID,message:Errors[Errors.E_VALUE_INVALID],domain:"TcHmi.ValueConverter",reason:"The value must not be null or undefined."},res;if("string"==typeof value&&""!==value)try{res.value=JSON.parse(value)}catch(e){res.error=Errors.E_VALUE_INVALID,e instanceof Error?res.details={code:Errors.E_VALUE_INVALID,message:Errors[Errors.E_VALUE_INVALID],domain:"TcHmi.ValueConverter",reason:"Converting string to object failed:"+e.message,exception:e}:res.details={code:Errors.E_VALUE_INVALID,message:Errors[Errors.E_VALUE_INVALID],domain:"TcHmi.ValueConverter",reason:String(e)}}else"object"==typeof value?null!==value&&(res.value=value):(res.error=Errors.E_VALUE_INVALID,res.details={code:Errors.E_VALUE_INVALID,message:Errors[Errors.E_VALUE_INVALID],domain:"TcHmi.ValueConverter",reason:"The value is not compatible with type object."});return res}
/**
 ...
 * @param options.defaultValue The fallback value (null if not given)
 * @preserve (Part of the public API)
 */export function toStringEx(value,options){const defaultValue=options?.defaultValue??null;let res={error:Errors.NONE,value:defaultValue};if(null==value)return res.error=Errors.E_VALUE_INVALID,res.details={code:Errors.E_VALUE_INVALID,message:Errors[Errors.E_VALUE_INVALID],domain:"TcHmi.ValueConverter",reason:"The value must not be null or undefined."},res;switch(typeof value){case"boolean":case"number":case"bigint":res.value=value.toString();break;case"object":value instanceof Date?res.value=value.toISOString():value instanceof baseTcHmiControl||value instanceof Element||(res.value=JSON.stringify(value));break;case"string":res.value=value;break;default:res.error=Errors.E_VALUE_INVALID,res.details={code:Errors.E_VALUE_INVALID,message:Errors[Errors.E_VALUE_INVALID],domain:"TcHmi.ValueConverter"}}return res}
/**
 ...
 * @param options.defaultValue The fallback value (null if not given)
 * @preserve (Part of the public API)
 */export function toBooleanEx(value,options){const defaultValue=options?.defaultValue??null;let res={error:Errors.NONE,value:defaultValue};if(null==value)return res.error=Errors.E_VALUE_INVALID,res.details={code:Errors.E_VALUE_INVALID,message:Errors[Errors.E_VALUE_INVALID],domain:"TcHmi.ValueConverter",reason:"The value must not be null or undefined."},res;switch(typeof value){case"string":switch(value.toLowerCase()){case"true":res.value=!0;break;case"false":res.value=!1;break;default:res.error=Errors.E_VALUE_INVALID,res.details={code:Errors.E_VALUE_INVALID,message:Errors[Errors.E_VALUE_INVALID],domain:"TcHmi.ValueConverter",reason:"The value must be either 'true' or 'false' without case sensitivity."},res.value=defaultValue}break;case"number":switch(value){case 1:res.value=!0;break;case 0:res.value=!1;break;default:res.error=Errors.E_VALUE_INVALID,res.details={code:Errors.E_VALUE_INVALID,message:Errors[Errors.E_VALUE_INVALID],domain:"TcHmi.ValueConverter",reason:"The value must be either '1' or '0'."},res.value=defaultValue}break;case"bigint":switch(value){case 1n:res.value=!0;break;case 0n:res.value=!1;break;default:res.error=Errors.E_VALUE_INVALID,res.details={code:Errors.E_VALUE_INVALID,message:Errors[Errors.E_VALUE_INVALID],domain:"TcHmi.ValueConverter",reason:"The value must be either '1n' or '0n'."},res.value=defaultValue}break;case"boolean":res.value=value;break;default:res.error=Errors.E_VALUE_INVALID,res.details={code:Errors.E_VALUE_INVALID,message:Errors[Errors.E_VALUE_INVALID],domain:"TcHmi.ValueConverter",reason:"The type of value must be 'string', 'number', 'bigint' or 'boolean'."},res.value=defaultValue}return res}
/**
 ...
 * @param options.defaultValue The fallback value (null if not given)
 * @preserve (Part of the public API)
 */export function toBigIntEx(value,options){const defaultValue=options?.defaultValue??null;let res={error:Errors.NONE,value:defaultValue};if(null==value)return res.error=Errors.E_VALUE_INVALID,res.details={code:Errors.E_VALUE_INVALID,message:Errors[Errors.E_VALUE_INVALID],domain:"TcHmi.ValueConverter",reason:"The value must not be null or undefined."},res;try{let bigint=BigInt(value);return"number"==typeof value&&bigint!=value?(res.error=Errors.E_VALUE_INVALID,res.details={code:Errors.E_VALUE_INVALID,message:Errors[Errors.E_VALUE_INVALID],domain:"TcHmi.ValueConverter",reason:"The value is not a valid bigint."},res.value=defaultValue,res):(res.value=bigint,res)}catch(e){if("string"!=typeof value)return res.error=Errors.E_EXCEPTION,e instanceof Error?res.details={code:Errors.E_EXCEPTION,message:Errors[Errors.E_EXCEPTION],domain:"TcHmi.ValueConverter",reason:"Converting value to BigInt failed:"+e.message,exception:e}:res.details={code:Errors.E_EXCEPTION,message:Errors[Errors.E_EXCEPTION],domain:"TcHmi.ValueConverter",reason:String(e)},res.value=defaultValue,res;try{let num=toNumber(value);if(null!==num){let bigint=BigInt(num);return bigint!=num?(res.error=Errors.E_VALUE_INVALID,res.details={code:Errors.E_VALUE_INVALID,message:Errors[Errors.E_VALUE_INVALID],domain:"TcHmi.ValueConverter",reason:"The value is not a valid bigint."},res.value=defaultValue,res):(res.value=bigint,res)}return res.error=Errors.E_EXCEPTION,e instanceof Error?res.details={code:Errors.E_EXCEPTION,message:Errors[Errors.E_EXCEPTION],domain:"TcHmi.ValueConverter",reason:"Converting value to BigInt failed:"+e.message,exception:e}:res.details={code:Errors.E_EXCEPTION,message:Errors[Errors.E_EXCEPTION],domain:"TcHmi.ValueConverter",reason:String(e)},res.value=defaultValue,res}catch(e){return res.error=Errors.E_EXCEPTION,e instanceof Error?res.details={code:Errors.E_EXCEPTION,message:Errors[Errors.E_EXCEPTION],domain:"TcHmi.ValueConverter",reason:"Converting value to BigInt failed:"+e.message,exception:e}:res.details={code:Errors.E_EXCEPTION,message:Errors[Errors.E_EXCEPTION],domain:"TcHmi.ValueConverter",reason:String(e)},res.value=defaultValue,res}}}
/**
 ...
 * @param options.defaultValue The fallback value (null if not given)
 * @preserve (Part of the public API)
 */export function toEnumEx(value,enumType,options){const defaultValue=options?.defaultValue??null;let res={error:Errors.NONE,value:defaultValue};if(null==value)return res.error=Errors.E_VALUE_INVALID,res.details={code:Errors.E_VALUE_INVALID,message:Errors[Errors.E_VALUE_INVALID],domain:"TcHmi.ValueConverter",reason:"The value must not be null or undefined."},res;switch(typeof value){case"string":if(""===value)break;const numValue=parseInt(value,10);isNaN(numValue)?(res.value=enumType[value],void 0===res.value&&(res.value=enumType[value.toLowerCase()]),void 0===res.value&&(res.value=enumType[value.toUpperCase()]),void 0===res.value&&(res.error=Errors.E_VALUE_INVALID,res.details={code:Errors.E_VALUE_INVALID,message:Errors[Errors.E_VALUE_INVALID],domain:"TcHmi.ValueConverter",reason:"The value is not valid for the given enumeration."},res.value=defaultValue)):res=toEnumEx(numValue,enumType,defaultValue);break;case"number":void 0!==enumType[value]?res.value=value:(res.error=Errors.E_VALUE_INVALID,res.details={code:Errors.E_VALUE_INVALID,message:Errors[Errors.E_VALUE_INVALID],domain:"TcHmi.ValueConverter",reason:"The value is not valid for the given enumeration."},res.value=defaultValue);break;case"boolean":res=toEnumEx(toNumber(value),enumType,defaultValue);break;default:res.error=Errors.E_VALUE_INVALID,res.details={code:Errors.E_VALUE_INVALID,message:Errors[Errors.E_VALUE_INVALID],domain:"TcHmi.ValueConverter",reason:"The value must be of type 'string', 'number' or 'boolean'."},res.value=defaultValue}return res}
/**
 ...
 * @param options.convertDirection Direction of conversion.
 * @preserve (Part of the public API)
 */export function toTypeEx(value,typeName,options){if(null==value){return{error:Errors.E_VALUE_INVALID,details:{code:Errors.E_VALUE_INVALID,message:Errors[Errors.E_VALUE_INVALID],domain:"TcHmi.ValueConverter",reason:"The value must not be null or undefined."},value:null}}const schemaRes=typeManager.getSchemaEx(typeName);if(schemaRes.error!==Errors.NONE){return{error:schemaRes.error,details:{code:schemaRes.error,message:Errors[schemaRes.error],domain:"TcHmi.ValueConverter",reason:"Resolving the schema: '"+typeName+"' failed.",errors:schemaRes.details?[schemaRes.details]:void 0},value:null}}const valueRes=toSchemaType(value,schemaRes.schema,options);return{error:Errors.NONE,value:valueRes}}
/**
 ...
 * @param options.resolveFunctionWriteValue A schema which describes a function on the server will describe the type of return value on root level. Set this option to true to resolve the writeValue schema instead.
 * @preserve (Part of the public API)
 */export function toSchemaTypeEx(value,schema,options){if(null==value){return{error:Errors.E_VALUE_INVALID,details:{code:Errors.E_VALUE_INVALID,message:Errors[Errors.E_VALUE_INVALID],domain:"TcHmi.ValueConverter",reason:"The value must not be null or undefined."},value:null}}if(null==schema)return{error:Errors.E_PARAMETER_INVALID,details:{code:Errors.E_PARAMETER_INVALID,message:Errors[Errors.E_PARAMETER_INVALID],domain:"TcHmi.ValueConverter",reason:"The parameter: 'schema' must be a valid object of type: 'TcHmi.JsonSchema'."},value:null};if(options&&options.resolveFunctionWriteValue&&schema.writeValue)return toSchemaTypeEx(value,schema.writeValue,options.convertDirection?{convertDirection:options.convertDirection}:void 0);const typeOfValue=typeof value,ruleSchemaMap=SystemSchema.resolveTypeConvertRuleSchemaMap(schema);if(ruleSchemaMap){if(options&&options.convertDirection===ConvertDirection.Backward){let res;for(const key of ruleSchemaMap.keys()){if(!key)continue;const ruleSchemas=ruleSchemaMap.get(key);if(ruleSchemas&&"string"===key)for(let ruleSchema of ruleSchemas){if(res=toString(value),ruleSchema&&(!ruleSchema.enum||ruleSchema.enum&&ruleSchema.enum.includes(res)))break;res=void 0}if(void 0!==res)break}if(void 0!==res)return{error:Errors.NONE,value:res}}else{const ruleSchemas=ruleSchemaMap.get(typeOfValue);if(ruleSchemas)for(let ruleSchema of ruleSchemas)switch(ruleSchema.convert){case"number":{let res=toNumberEx(value);if(res.error===Errors.NONE)return res;break}case"string":{let res=toStringEx(value);if(res.error===Errors.NONE)return res}break;case"boolean":{let res=toBooleanEx(value);if(res.error===Errors.NONE)return res}break;case"bigint":{let res=toBigIntEx(value);if(res.error===Errors.NONE)return res}break;case"bigint64":{let res=toBigInt64Ex(value);if(res.error===Errors.NONE)return res}break;case"unsignedbigint64":{let res=toUnsignedBigInt64Ex(value);if(res.error===Errors.NONE)return res}}}for(let entry of ruleSchemaMap.entries())for(let ruleSchema of entry[1])if(typeOfValue===ruleSchema.convert||"bigint"===typeOfValue&&("bigint64"===ruleSchema.convert||"unsignedbigint64"===ruleSchema.convert))return{error:Errors.NONE,value}}const schemaType=SystemSchema.resolveType(schema);if("string"!=typeof schemaType&&!Array.isArray(schemaType))return{error:Errors.ERROR,details:{code:Errors.ERROR,message:Errors[Errors.ERROR],domain:"TcHmi.ValueConverter",reason:"Failed to resolve type from given schema."},value:null};if(Array.isArray(schemaType)){if("string"===typeOfValue||"number"===typeOfValue||"boolean"===typeOfValue||"object"===typeOfValue){if(schemaType.includes(typeOfValue))return{error:Errors.NONE,value};for(const validType of schemaType){let res;switch(validType){case"object":case"array":res=toObjectEx(value);break;case"string":res=toStringEx(value);break;case"integer":case"number":res=toNumberEx(value);break;case"boolean":res=toBooleanEx(value);break;default:res=null}if(null!==res)return{error:Errors.NONE,value:res.value}}}}else switch(schemaType){case"object":case"array":return toObjectEx(value);case"string":return toStringEx(value);case"integer":case"number":return toNumberEx(value);case"boolean":return toBooleanEx(value)}return{error:Errors.E_VALUE_INVALID,details:{code:Errors.E_VALUE_INVALID,message:Errors[Errors.E_VALUE_INVALID],domain:"TcHmi.ValueConverter",reason:"The value is not compatible with any definition in the given schema."},value:null}}export var ConvertDirection;!function(ConvertDirection){ConvertDirection[ConvertDirection.Forward=0]="Forward",ConvertDirection[ConvertDirection.Backward=1]="Backward"}(ConvertDirection||(ConvertDirection={}));TcHmi.ValueConverter={toObject,toObjectEx,toString,toStringEx,toDimensionUnit,toDimensionUnitEx,toAngleUnit,toAngleUnitEx,toBorderStyleValue,toBorderStyleValueEx,toFontStyle,toFontStyleEx,toFontSizeUnit,toFontSizeUnitEx,toFontWeight,toFontWeightEx,toHorizontalAlignment,toHorizontalAlignmentEx,toScaleModeString,toScaleModeStringEx,toSizeMode,toSizeModeEx,toSizeModeWithContent,toSizeModeWithContentEx,toVerticalAlignment,toVerticalAlignmentEx,toVisibility,toVisibilityEx,toToggleState,toToggleStateEx,toFontFamily,toFontFamilyEx,toNumber,toNumberEx,toBoolean,toBooleanEx,toBigInt,toBigIntEx,toBigInt64,toBigInt64Ex,toUnsignedBigInt64,toUnsignedBigInt64Ex,toEnum,toEnumEx,toType,toTypeEx,toSchemaType,toSchemaTypeEx,ConvertDirection};