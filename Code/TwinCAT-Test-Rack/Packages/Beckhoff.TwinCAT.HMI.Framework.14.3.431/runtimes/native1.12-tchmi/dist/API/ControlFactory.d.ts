 ...
 */
declare function create<C extends baseTcHmiControl>(html: string, unused?: null, parent?: baseTcHmiControl | null): C | undefined;
/**
 * DEPRECATED
 * Creates a new control.
 ...
 * @deprecated Please use createEx()
 */
declare function create<C extends baseTcHmiControl>(element: JQuery, unused?: null, parent?: baseTcHmiControl | null): C | undefined;
/**
 * DEPRECATED
 * Creates a new control.
 * @param type The type of the control.
 ...
 * @deprecated Please use createEx()
 */
declare function create<C extends baseTcHmiControl>(type: string, id: string, parent?: baseTcHmiControl | null): C | undefined;
