 ...
 * @returns returns an Error code
 * @preserve (Part of the public API)
 */export function releaseThemeValue(control,propertyName){return control instanceof baseTcHmiControl?isParameterTypeInvalid(propertyName,"propertyName",{type:"string",required:"valueNeeded",minStringLength:1})?Errors.E_PARAMETER_INVALID:(themeManager.unwatchAttributeDefaults(control,propertyName),Errors.NONE):Errors.E_PARAMETER_INVALID}TcHmi.Theme??={},TcHmi.Theme.Properties={getDefaultValue,setThemeValue,releaseThemeValue};