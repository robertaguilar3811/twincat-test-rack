 ...
 */
export declare function checkAccess(control: Readonly<baseTcHmiControl>, requestedAccessright: string): boolean | null;
/**
 ...
 */
export declare function setControlRightOverride(control: Readonly<baseTcHmiControl>, accessrightToOverride: string, forcedRight: 'Deny' | null): boolean;
/**
 * Returns a Set with a list of all overridden deny rights for a control.
 * Gives an empty Set when no right is overridden.
 * @param control Control to check
 */
export declare function getControlRightOverrides(control: Readonly<baseTcHmiControl>): Set<string>;
