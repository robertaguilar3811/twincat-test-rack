 ...
 */
export declare function create(expression: string, fn: (value: any) => void, control: baseTcHmiControl): void;
/**
 ...
 * @preserve (Part of the public API)
 */
export declare function createEx(expression: string, fn: string, control: baseTcHmiControl): void;
/**
 ...
 * @preserve (Part of the public API)
 */
export declare function createEx2(expression: string, propertyName: string, control: baseTcHmiControl, options?: {
    ctx?: Context;
}): void;
/**
 ...
 * @preserve (Part of the public API)
 */
export declare function remove(expression: string | null, fn: (value: any) => void, control: baseTcHmiControl, bReset?: boolean): void;
/**
 * Removes a binding between a symbol and a control attribute setter function.
 * @param expression [OBSOLETE] The target symbol expression.
 * @param fn The name of the control setter function.
 ...
 * @preserve (Part of the public API)
 */
export declare function removeEx(expression: string | null, fn: string, control: baseTcHmiControl, bReset?: boolean): void;
/**
 ...
 * @preserve (Part of the public API)
 */
export declare function removeEx2(_unused: string | null, propertyName: string, control: baseTcHmiControl, bReset?: boolean): void;
/**
 ...
 * @preserve (Part of the public API)
 */
export declare function exists(propertyName: string, control: baseTcHmiControl): boolean;
/**
 ...
 * @preserve (Part of the public API)
 */
export declare function resolve(propertyName: string, control: baseTcHmiControl): string | null;
/**
 ...
 * @preserve (Part of the public API)
 */
export declare function resolveEx(propertyName: string, control: baseTcHmiControl): SymbolExpression | null;
