export class Destroyable{__isDestroyed=!1;
/**
...
/**
     ...
     * @preserve (Part of the public API)
     */claimDestroyPrivilege(){this.isDestroyed()||this.__destroyPrivileges++}}const _Destroyable=Destroyable;TcHmi.Destroyable=_Destroyable;