...
import { baseTcHmiControl } from '../baseTcHmiControl.js';
import { ObjectResolver } from '../../../API/ObjectResolver.js';
import { ControlLocalization } from '../../../API/Locale.js';
import type { AccessControl, Background, BorderRadius, BorderStyle, BorderWidth, BoxShadow, Color, ControlAttributeDescription, DestroyFunction, DimensionUnit, FourSidedCss, HorizontalAlignment, SizeMode, SizeModeWithContent, Transform, Version, VerticalAlignment, VirtualControlRightMapping, Visibility } from '../../../API/_Types.js';
import type { Trigger } from '../../../API/Trigger.js';
/**
...
declare class TcHmiControl extends baseTcHmiControl {
     ...
     */
    protected __onResolverForTransformWatchCallback(data: ObjectResolver.IWatchResultObject<Transform[]>): void;
    /**
     ...
     */
    protected __onResolverForBackgroundColorWatchCallback(data: ObjectResolver.IWatchResultObject<Color>): void;
    /**
     ...
     */
    protected __onResolverForBackgroundImagePaddingWatchCallback(data: ObjectResolver.IWatchResultObject<FourSidedCss>): void;
    /**
     ...
     */
    protected __onResolverForBorderColorWatchCallback(data: ObjectResolver.IWatchResultObject<Color>): void;
    /**
     ...
     */
    protected __onResolverForBorderWidthWatchCallback(data: ObjectResolver.IWatchResultObject<BorderWidth>): void;
    /**
     ...
     */
    protected __onResolverForBorderRadiusWatchCallback(data: ObjectResolver.IWatchResultObject<BorderRadius>): void;
    /**
     ...
     */
    protected __onResolverForBorderStyleWatchCallback(data: ObjectResolver.IWatchResultObject<BorderStyle>): void;
    /**
     ...
     */
    protected __onResolverForBoxShadowWatchCallback(data: ObjectResolver.IWatchResultObject<BoxShadow[]>): void;
    /**
