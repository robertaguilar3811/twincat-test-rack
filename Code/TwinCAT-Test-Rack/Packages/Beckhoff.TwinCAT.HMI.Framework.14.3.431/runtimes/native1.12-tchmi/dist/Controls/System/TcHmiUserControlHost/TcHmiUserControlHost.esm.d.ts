...
import type { ControlAttributeDescription as BaseControlAttributeDescription, SizeModeWithContent } from '../../../API/_Types.js';
declare class TcHmiUserControlHost extends TcHmiControl {
    ...
    protected __partialDefaultVirtualRights: Map<string, Controls.ControlAccessDescription>;
...
export interface ControlAttributeDescription extends BaseControlAttributeDescription {
