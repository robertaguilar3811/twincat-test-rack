...
import { PopupProvider } from '../../../API/UiProvider.PopupProvider.js';
import { Control as TcHmiControl } from '../TcHmiControl/TcHmiControl.esm.js';
import { Control as TcHmiRegion } from '../TcHmiRegion/TcHmiRegion.esm.js';
import { Control as TcHmiUserControlHost } from '../TcHmiUserControlHost/TcHmiUserControlHost.esm.js';
import type { TcHmiUserControlParameter } from '../TcHmiUserControlHost/TcHmiUserControlHost.esm.js';
import type * as Trigger from '../../../API/Trigger.js';
import type { DestroyFunction, Dictionary, FourSidedCss } from '../../../API/_Types.js';
import { ObjectResolver } from '../../../API/ObjectResolver.js';
declare class TcHmiPopup extends TcHmiControl {
    #private;
     ...
     */
    protected __onResolverForTargetFileWatchCallback(data: ObjectResolver.IWatchResultObject<TargetFile>): void;
    /**
