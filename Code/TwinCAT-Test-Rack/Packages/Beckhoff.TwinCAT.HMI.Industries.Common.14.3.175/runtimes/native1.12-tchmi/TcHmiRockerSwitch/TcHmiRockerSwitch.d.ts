declare namespace TcHmi.Controls.Beckhoff.Industries.Common {
    class TcHmiRockerSwitch extends TcHmi.Controls.Beckhoff.TcHmiButton {
        #private;
         ...
         */
        protected __orientation: TcHmiRockerSwitch.Orientation | undefined;
         ...
         */
        setOrientation(valueNew: TcHmiRockerSwitch.Orientation | null): void;
        /**
         * Returns the current  value of the orientation attribute
         */
        getOrientation(): TcHmiRockerSwitch.Orientation | undefined;
        /**
...
//# sourceMappingURL=TcHmiRockerSwitch.d.ts.map